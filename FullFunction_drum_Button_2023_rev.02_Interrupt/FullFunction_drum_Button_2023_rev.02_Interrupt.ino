...
/***************ขา interrupt สำหรับ Arduino แต่ละรุ่นไม่เหมือนกัน******************************
...
*******interrupt สำหรับ Arduino*****************************************/
//Resistor ตัวต้านทาน 4.7 K Ohm 1/4W 
//สวิตช์กดติดปล่อยดับ
...
/********************************************
 // เลข 1 คือเลข Interrupt สำหรับ Arduino Uno เลข 1 อยู่ที่ขา 3
  // blink คือ ฟังก์ชั่นของเรา ที่เมื่อเกิด interrupt ให้ทำงานในนี้
  // RISING คือ เมื่อเกิดเหตุการณ์ของขา interrupt เปลี่ยนจากไฟต่ำเป็นสูง ให้ทำในฟังก์ชั่น blink
...
attachInterrupt(1, blink, RISING);        // กำหนดขา  เลข Interrupt สำหรับ Arduino Uno เลข 1 อยู่ที่ขา 3
...
void loop()
//  เมื่อเราทำการกดปุ่ม สถานะที่ขา 3  //
//  จะเปลี่ยนจาก LOW เป็น HIGH โปรแกรมจะโดดมาทำงานใน ฟังก์ชั่น   void blink() ทันที  //
